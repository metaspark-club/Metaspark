        ...
        <div className="relative bg-gray-800/80 backdrop-blur-xl p-8 rounded-2xl border border-orange-500/30">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-gray-400 font-semibold text-xl mb-1">Username</h3>
                <p className="text-orange-500">{user?.username || 'Not set'}</p>
              </div>
              <div>
                <h3 className="text-gray-400 font-semibold text-xl mb-1">Email</h3>
                <p className="text-orange-500">{user?.email || 'Not set'}</p>
              </div>
              <div>
                <h3 className="text-gray-400 font-semibold text-xl mb-1">User ID</h3>

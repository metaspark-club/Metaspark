...
export default function MarketPage() {
  ...
  const [selectedDigisket, setSelectedDigisket] = useState<Digisket | null>(null)
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 mt-4">Trade digital assets and enhance your collection</p>
      </div>
            ...
            <div className="relative bg-gray-800/80 backdrop-blur-xl p-8 rounded-2xl border border-orange-500/30 hover:border-gray-400/60 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,165,0,0.4)]">
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 font-bold">{digisket.price} credits</span>
                  <button
                    onClick={(e) => {
                      e.stopPropagation()

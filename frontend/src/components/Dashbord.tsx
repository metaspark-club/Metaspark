...
export default function Dashboard() {
  ...
  const menuItems: MenuItem[] = [
    { id: 1, title: 'Chat', icon: '💬', path: '/chat', description: 'Connect with others' },
    { id: 2, title: 'Social Labyrinth', icon: '🌐', path: '/rand', description: 'random chatting' },
    { id: 3, title: 'Digiskets Market', icon: '🛍️', path: '/market', description: 'Trade digital assets' },
    { id: 4, title: 'Games', icon: '🎮', path: '/game', description: 'Enter the arena' },
    { id: 5, title: 'Profile', icon: '👤', path: '/profile', description: 'Your digital identity' },
    { id: 6, title: 'AI Chat', icon: '🤖', path: '/ai-chat', description: 'Talk to the future' },
  ]
  ...
  return (
    <div className="h-screen bg-gray-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center mt-[34px]">
        ...
        <p className="text-gray-400 text-lg font-light tracking-wider">ENTER THE DIGITAL REALM</p>
      </div>
              ...
              >
                <div className="relative bg-gray-800/80 backdrop-blur-xl p-8 rounded-2xl border border-orange-500/30 hover:border-gray-400/60 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,165,0,0.4)]">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-gray-400 font-semibold text-center text-2xl mb-2 font-orbitron">{item.title}</h3>
                    <p className="text-orange-500 text-center text-sm font-light">{item.description}</p>
                  </div>
                </div>
              </Link>
            )

  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <div className="w-1/3 border-r border-orange-500/20 p-4 overflow-y-auto bg-gray-800/50 backdrop-blur-sm">
        <h2 className="text-xl font-bold mb-4 text-orange-400 font-orbitron">Active Users</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {selectedUser ? (
            ...
            <div className="h-full flex items-center justify-center">
              <p className="text-gray-400 font-orbitron">Select a user to start chatting</p>
            </div>
          )}
        </div>
